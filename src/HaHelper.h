...
public:
  ...
  bool publishSelectOutdoorSensorType(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_COMMAND_TOPIC)] = this->getDeviceTopic("settings/set").c_str();
    ...
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("outdoor_sensor_type").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("outdoor_sensor_type").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
    doc[FPSTR(HA_NAME)] = F("Outdoor temperature source");
    doc[FPSTR(HA_STATE_TOPIC)] = this->getDeviceTopic("settings").c_str();
...
#endif
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("indoor_sensor_type").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("indoor_sensor_type").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
  ...
  bool publishNumberOutdoorSensorOffset(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("settings").c_str();
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_VALUE_TEMPLATE)] = F("{{ iif(value_json.sensors.outdoor.type != 1, 'online', 'offline') }}");
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("outdoor_sensor_offset").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("outdoor_sensor_offset").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
  ...
  bool publishNumberIndoorSensorOffset(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("indoor_sensor_offset").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("indoor_sensor_offset").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("temperature");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishSwitchDebug(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("debug").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("debug").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
  ...
  bool publishSwitchEmergency(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("emergency").c_str();
  ...
  bool publishNumberEmergencyTarget(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("emergency_target").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("emergency_target").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("temperature");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishSwitchEmergencyUseEquitherm(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_VALUE_TEMPLATE)] = F("{{ iif(value_json.sensors.outdoor.type != 1, 'online', 'offline') }}");
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("emergency_use_equitherm").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("emergency_use_equitherm").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
  ...
  bool publishSwitchHeating(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("heating").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("heating").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
  ...
  bool publishSwitchHeatingTurbo(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("heating_turbo").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("heating_turbo").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
  ...
  bool publishNumberHeatingTarget(byte minTemp = 20, byte maxTemp = 90, bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("heating_target").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("heating_target").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("temperature");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishNumberHeatingHysteresis(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("heating_hysteresis").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("heating_hysteresis").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("temperature");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishSensorHeatingSetpoint(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("heating_setpoint").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("heating_setpoint").c_str();
    ...
    doc[FPSTR(HA_STATE_TOPIC)] = this->getDeviceTopic("state").c_str();
  ...
  bool publishSensorCurrentHeatingMinTemp(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("current_heating_min_temp").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("current_heating_min_temp").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("diagnostic");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("temperature");
    doc[FPSTR(HA_STATE_CLASS)] = F("measurement");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishSensorCurrentHeatingMaxTemp(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("current_heating_max_temp").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("current_heating_max_temp").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("diagnostic");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("temperature");
    doc[FPSTR(HA_STATE_CLASS)] = F("measurement");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishNumberHeatingMinTemp(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("heating_min_temp").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("heating_min_temp").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("temperature");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishNumberHeatingMaxTemp(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("heating_max_temp").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("heating_max_temp").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("temperature");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishNumberHeatingMaxModulation(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("heating_max_modulation").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("heating_max_modulation").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
  ...
  bool publishSwitchDhw(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("dhw").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("dhw").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
  ...
  bool publishNumberDhwTarget(byte minTemp = 40, byte maxTemp = 60, bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("dhw_target").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("dhw_target").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("temperature");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishSensorCurrentDhwMinTemp(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("current_dhw_min_temp").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("current_dhw_min_temp").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("diagnostic");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("temperature");
    doc[FPSTR(HA_STATE_CLASS)] = F("measurement");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishSensorCurrentDhwMaxTemp(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("current_dhw_max_temp").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("current_dhw_max_temp").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("diagnostic");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("temperature");
    doc[FPSTR(HA_STATE_CLASS)] = F("measurement");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishNumberDhwMinTemp(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("dhw_min_temp").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("dhw_min_temp").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("temperature");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishNumberDhwMaxTemp(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("dhw_max_temp").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("dhw_max_temp").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("temperature");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishSwitchPID(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("pid").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("pid").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
  ...
  bool publishNumberPIDFactorP(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("pid_p").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("pid_p").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
  ...
  bool publishNumberPIDFactorI(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("pid_i").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("pid_i").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
  ...
  bool publishNumberPIDFactorD(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("pid_d").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("pid_d").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
  ...
  bool publishNumberPIDMinTemp(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("pid_min_temp").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("pid_min_temp").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("temperature");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishNumberPIDMaxTemp(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("pid_max_temp").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("pid_max_temp").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("temperature");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishSwitchEquitherm(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("equitherm").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("equitherm").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
  ...
  bool publishNumberEquithermFactorN(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("equitherm_n").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("equitherm_n").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
  ...
  bool publishNumberEquithermFactorK(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("equitherm_k").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("equitherm_k").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
  ...
  bool publishNumberEquithermFactorT(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("equitherm_t").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("equitherm_t").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
  ...
  bool publishSwitchTuning(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("tuning").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("tuning").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
    ...
    doc[FPSTR(HA_COMMAND_TOPIC)] = this->getDeviceTopic("state/set").c_str();
  ...
  bool publishSelectTuningRegulator(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("tuning_regulator").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("tuning_regulator").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
  ...
  bool publishBinSensorStatus(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("status").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("status").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("diagnostic");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("problem");
    doc[FPSTR(HA_NAME)] = F("Status");
    doc[FPSTR(HA_ICON)] = F("mdi:list-status");
    doc[FPSTR(HA_STATE_TOPIC)] = this->getDeviceTopic("status").c_str();
  ...
  bool publishBinSensorOtStatus(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("ot_status").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("ot_status").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("diagnostic");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("problem");
  ...
  bool publishBinSensorFlame(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("flame").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("flame").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("diagnostic");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("running");
  ...
  bool publishBinSensorFault(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("state").c_str();
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_VALUE_TEMPLATE)] = F("{{ iif(value_json.states.otStatus, 'online', 'offline') }}");
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("fault").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("fault").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("diagnostic");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("problem");
  ...
  bool publishBinSensorDiagnostic(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("diagnostic").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("diagnostic").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("diagnostic");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("problem");
  ...
  bool publishSensorFaultCode(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("fault_code").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("fault_code").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("diagnostic");
  ...
  bool publishSensorRssi(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("rssi").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("rssi").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("diagnostic");
  ...
  bool publishSensorUptime(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("uptime").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("uptime").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("diagnostic");
  ...
  bool publishSensorModulation(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("modulation_level").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("modulation_level").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("diagnostic");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("power_factor");
    doc[FPSTR(HA_STATE_CLASS)] = F("measurement");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("%");
  ...
  bool publishSensorPressure(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("pressure").c_str();
  ...
  bool publishSensorDhwFlowRate(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("dhw_flow_rate").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("dhw_flow_rate").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("diagnostic");
  ...
  bool publishNumberIndoorTemp(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("indoor_temp").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("indoor_temp").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishSensorIndoorTemp(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_AVAILABILITY)][0][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
  ...
  bool publishNumberOutdoorTemp(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("outdoor_temp").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("outdoor_temp").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishSensorHeatingTemp(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("heating_temp").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("heating_temp").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("diagnostic");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("temperature");
    doc[FPSTR(HA_STATE_CLASS)] = F("measurement");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishSensorDhwTemp(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_TOPIC)] = this->getDeviceTopic("status").c_str();
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("dhw_temp").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("dhw_temp").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("diagnostic");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("temperature");
    doc[FPSTR(HA_STATE_CLASS)] = F("measurement");
    doc[FPSTR(HA_UNIT_OF_MEASUREMENT)] = F("°C");
  ...
  bool publishClimateHeating(byte minTemp = 20, byte maxTemp = 90, byte currentTempSource = HaHelper::TEMP_SOURCE_HEATING, bool enabledByDefault = true) {
    ...
    if (currentTempSource == HaHelper::TEMP_SOURCE_HEATING || currentTempSource == HaHelper::TEMP_SOURCE_INDOOR) {
      doc[FPSTR(HA_CURRENT_TEMPERATURE_TOPIC)] = this->getDeviceTopic("state").c_str();
    }
    ...
    doc[FPSTR(HA_TEMPERATURE_COMMAND_TOPIC)] = this->getDeviceTopic("settings/set").c_str();
    doc[FPSTR(HA_TEMPERATURE_COMMAND_TEMPLATE)] = F("{\"heating\": {\"target\" : {{ value }}}}");

    doc[FPSTR(HA_TEMPERATURE_STATE_TOPIC)] = this->getDeviceTopic("settings").c_str();
    doc[FPSTR(HA_TEMPERATURE_STATE_TEMPLATE)] = F("{{ value_json.heating.target|float(0)|round(1) }}");

    doc[FPSTR(HA_MODE_COMMAND_TOPIC)] = this->getDeviceTopic("settings/set").c_str();
    doc[FPSTR(HA_MODE_COMMAND_TEMPLATE)] = F("{% if value == 'heat' %}{\"heating\": {\"enable\" : true}}"
      "{% elif value == 'off' %}{\"heating\": {\"enable\" : false}}{% endif %}");
    doc[FPSTR(HA_MODE_STATE_TOPIC)] = this->getDeviceTopic("settings").c_str();
    ...
    doc[FPSTR(HA_ACTION_TOPIC)] = this->getDeviceTopic("state").c_str();
    doc[FPSTR(HA_ACTION_TEMPLATE)] = F("{{ iif(value_json.states.heating, 'heating', 'idle') }}");

    doc[FPSTR(HA_PRESET_MODE_COMMAND_TOPIC)] = this->getDeviceTopic("settings/set").c_str();
    doc[FPSTR(HA_PRESET_MODE_COMMAND_TEMPLATE)] = F("{% if value == 'boost' %}{\"heating\": {\"turbo\" : true}}"
      "{% elif value == 'none' %}{\"heating\": {\"turbo\" : false}}{% endif %}");
    doc[FPSTR(HA_PRESET_MODE_STATE_TOPIC)] = this->getDeviceTopic("settings").c_str();
  ...
  bool publishButtonRestart(bool enabledByDefault = true) {
    JsonDocument doc;
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("restart").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("restart").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
  ...
  bool publishButtonResetFault(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_AVAILABILITY)][FPSTR(HA_VALUE_TEMPLATE)] = F("{{ iif(value_json.states.fault, 'online', 'offline') }}");
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("reset_fault").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("reset_fault").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("restart");
  ...
  bool publishButtonResetDiagnostic(bool enabledByDefault = true) {
    ...
    doc[FPSTR(HA_ENABLED_BY_DEFAULT)] = enabledByDefault;
    doc[FPSTR(HA_UNIQUE_ID)] = this->getObjectId("reset_diagnostic").c_str();
    doc[FPSTR(HA_OBJECT_ID)] = this->getObjectId("reset_diagnostic").c_str();
    doc[FPSTR(HA_ENTITY_CATEGORY)] = F("config");
    doc[FPSTR(HA_DEVICE_CLASS)] = F("restart");
